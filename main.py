...
<head>
    ...
    <style>
        ...
        .tool-btn { background: #334155; color: #f8fafc; border: 1px solid #475569; font-size: 0.85rem; padding: 0.4rem 0.8rem; border-radius: 0.375rem; cursor: pointer; white-space: nowrap; }
