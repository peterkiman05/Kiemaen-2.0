...
class FreelanceTaskRequest(BaseModel):
    task_type: str  # e.g., "code_debug", "technical_docs", "marketing_copy", "data_synthesis"
    client_prompt: str
    tone: Optional[str] = "professional"

@router.post("/api/freelance/execute", dependencies=[Depends(verify_security_and_rate_limit)])
