...
class LifeEngine:
    ...
    def get_advice(full_context: str):
        ...
        if ("spend" in cat or "budget" in cat or "plan" in cat or "income" in cat or "salary" in cat or "eater" in cat or "transport" in cat) and numbers:
            ...
            if "transport" in cat and ("cover" in cat or "paid" in cat or "sorted" in cat):
        ...
        adversity_keywords = ["poor", "broke", "struggl", "debt", "scarce", "hardship", "income", "money", "cash"]
        wealth_keywords = ["rich", "wealth", "abundan", "invest", "capital", "million", "portfolio"]
        grief_keywords = ["heart", "break", "grief", "loss", "pain", "breakup", "betray"]
        joy_keywords = ["happy", "joy", "thriv", "excited", "success", "winning"]
        sad_keywords = ["sad", "depress", "overwhelm", "lost", "burnt", "stress", "anxiety", "exhaust"]
